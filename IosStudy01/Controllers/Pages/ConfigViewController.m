...
-(void) initData {
    ...
    // avatar
    ConfigEntry* avatarEntry = [ConfigEntry entryWithTitle:@"我的信息" withIcon:@"avatar_default_big.jpg" withMode : ModeLarge];
    ...
    // homepage
    ConfigEntry* homePageEntry = [ConfigEntry entryWithTitle:@"我的主页" withIcon:@"my_page_btn_bg" withMode : ModeMedium];
    ConfigEntry* favorEntry = [ConfigEntry entryWithTitle:@"我的收藏" withIcon:@"my_favorite_bg" withMode : ModeMedium];
    ConfigEntry* creditEntry = [ConfigEntry entryWithTitle:@"我的积分" withIcon:@"my_credits_bg" withMode : ModeMedium];
    ...
    // class
    ConfigEntry* classPageEntry = [ConfigEntry entryWithTitle:@"我的班级" withIcon:@"my_favorite_bg" withMode : ModeMedium];
    ...
    // config
    ConfigEntry* configEntry = [ConfigEntry entryWithTitle:@"设置" withIcon:@"my_setting_bg" withMode : ModeMedium];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    return entry.itemMode == ModeLarge ? 80 : 48;
}
